...
.github/workflows/build.yml at d409cd7
name: Build
...
jobs:
  ...
  build_android:
    ...
    steps:
      ...
      #     cd clients/android
      #     ./gradlew :app:assemblePlayRelease :app:assembleOtherRelease --stacktrace --scan
      #   env:
      #     JAVA_HOME: /usr/lib/jvm/java-17-openjdk-amd64
      #     ANDROID_NDK_HOME: ${{ steps.setup-ndk.outputs.ndk-path }}
  ...
  upload:
    ...
    steps:
      ...
      - name: Replace builds
        ...
        env:
          GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
Update build.yml · fengjiangjiang/sing-box@d409cd7
